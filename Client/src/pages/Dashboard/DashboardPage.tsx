      ...
      <div className={styles.dashboard__widgets}>
        <div className={styles.dashboard__widgets__orders}>
          ...
          <div className={styles.dashboard__widgets__orders__wrapper}>
            ...
            {!isFetching && (!orders?.length || !orders) && (
              <div
                className={styles.dashboard__widgets__orders__wrapper__noOrders}
              >
                <ImFileEmpty />
                <h3>No orders placed yet</h3>
                <h5
                  className={
                    styles.dashboard__widgets__orders__wrapper__noOrders__message
                  }
                >
